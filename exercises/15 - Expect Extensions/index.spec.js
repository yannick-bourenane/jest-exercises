  ...
  toBeFunction(received) {
    ...
    if (pass) {
      return {
        pass,
        message: () =>
          `expected value to not be a function; actual: ${typeof received}`,
      };
    }
    return {
      pass: false,
      message: () =>
        `expected value to be a function; actual: ${typeof received}`,
    };
  },
  toHaveProperty(received, argument) {
    ...
    if (pass) {
      return {
        pass,
        message: () =>
          `expected object to not have property: ${argument}; actual: ${Object.keys(
            received
          )}`,
      };
    }
    return {
      pass: false,
      message: () =>
        `expected object to be have property: ${argument}; actual: ${Object.keys(
          received
        )}`,
    };
  },
